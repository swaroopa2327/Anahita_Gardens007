...
<!-- Include user home nav which will be displayed when user is logged in  -->
  ...
  <div class="container myCompany" style ="margin-top:65px" >
      <div class="row">
          <div class ="col-lg-10 " style ="margin-left:125px;margin-right: 25px;margin-top:-20px">
              <div class ="media " >
                   <div class ="media-left ">
                        <img  class ="media-object " src="resources/ProductImages/{{pdo.pId}}.jpg" height="325px" width="300px"  />
                   </div>
                  ...
                  <div class ="media-body "  >
                      ...
                      <div class="product-desc" style ="margin-left:25px">
  							<div ><b>{{pdo.pDesc}}</b></div>
							<div class="product-buy " >                      
							         <h4 style ="margin-left:2px"><b>Rs.{{pdo.pPrice}}
 	              ...
 	              <div class ="cart buttons" style ="margin-top:2px">	                     
		                       <a href="Login" >
		                          		<button class="btn " style = "background-color:darkgreen;font-size:10pt ;color:white; margin-left:50px;">
														Buy Now <span class="glyphicon glyphicon-shopping-cart"style="margin-left:10px" ></span>
										</button>
		                        </a>  		                        
		                        <a href="ShowProducts" class="btn" id="viewproductsbutton">
                          				<button id="cartbutton" class="btn btn-primary "style="font-size:10pt ;color:white;margin-top:-3px ;margin-left:100px"">
												View more Products<span class="glyphicon glyphicon-search" style="margin-left:10px" ></span>
										</button>                           
                              </a>                                            
                       </div>
                       ...
                       <!-- when user is logged in the following buttons are displayed in user product zoom page
                       
                        <div class ="cart buttons" style ="margin-top:2px">	                     
		                       <a href="addtocart?getProductId={{pdo.ProductId}}" >
		                          		<button id="cartbutton" class="btn " style = "background-color:darkgreen;font-size:10pt ;color:white; margin-left:50px;">
														Add to Cart <span class="glyphicon glyphicon-shopping-cart"style="margin-left:10px" ></span>
										</button>
		                        </a>  		                        
		                        <a href="ShowProducts" class="btn" id="viewproductsbutton">
                          				<button id="cartbutton" class="btn btn-primary "style="font-size:10pt ;color:white;margin-top:-3px ;margin-left:100px"">
												Add more Products<span class="glyphicon glyphicon-search" style="margin-left:10px" ></span>
										</button>                           
                              </a>                                            
                       </div> -->
